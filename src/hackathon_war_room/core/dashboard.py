...
def render_dashboard(profile: dict[str, Any], rules: dict[str, Any], report: dict[str, Any]) -> str:
    ...
    main = _tag("main", hero + cards + scorecard + lens + action + footer, "class=\"wrap\"")
