...
def render_dashboard(profile: dict[str, Any], rules: dict[str, Any], report: dict[str, Any]) -> str:
    ...
    css = ":root{--bg:#050000;--panel:#100608;--panel2:#1a080c;--text:#fff5f5;--muted:#b88989;--violet:#991b1b;--cyan:#ff3b3b;--red:#ef121f;--gold:#ffb347;--green:#22c55e;--steel:#2b2f36}*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;font-family:Inter,Segoe UI,Arial,sans-serif;background:#050000;color:var(--text);background-image:radial-gradient(circle at 18% 0%,rgba(239,18,31,.35),transparent 34%),radial-gradient(circle at 82% 12%,rgba(120,0,0,.28),transparent 36%),linear-gradient(135deg,#020000 0%,#080102 42%,#150307 100%);position:relative}body:before{content:\"0001100011100 0100110011010 1110001011001 0011010011100 1011000111001\";position:fixed;inset:0;z-index:-2;color:rgba(239,18,31,.105);font-family:monospace;font-size:18px;letter-spacing:.28em;line-height:2.2;white-space:pre-wrap;word-break:break-all;transform:skewY(-8deg);padding:30px;overflow:hidden}body:after{content:\"\";position:fixed;inset:0;z-index:-1;background:linear-gradient(90deg,rgba(239,18,31,.045) 1px,transparent 1px),linear-gradient(180deg,rgba(239,18,31,.035) 1px,transparent 1px);background-size:44px 44px}.shell{display:grid;grid-template-columns:210px 1fr;min-height:100vh}.side-nav{position:sticky;top:0;height:100vh;padding:22px 16px;background:linear-gradient(180deg,rgba(7,7,12,.96),rgba(16,17,28,.92));border-right:1px solid rgba(244,63,94,.22);box-shadow:24px 0 60px rgba(244,63,94,.08)}.brand-mark{font-weight:900;letter-spacing:.16em;color:var(--red);font-size:12px;text-transform:uppercase;margin:10px 0 22px}.nav-item{display:block;text-decoration:none;color:var(--text);padding:14px 14px;margin:10px 0;border:1px solid rgba(255,255,255,.08);border-radius:14px;background:rgba(255,255,255,.025);font-size:13px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}.nav-item:hover,.nav-item.active{border-color:rgba(244,63,94,.65);background:rgba(244,63,94,.14);box-shadow:0 0 28px rgba(244,63,94,.18)}.wrap{max-width:1180px;margin:0 auto;padding:36px 22px 54px}.hero{border:1px solid rgba(239,18,31,.42);background:linear-gradient(135deg,rgba(35,0,4,.92),rgba(12,2,4,.78)),radial-gradient(circle at top right,rgba(239,18,31,.22),transparent 42%);box-shadow:0 0 80px rgba(239,18,31,.18),inset 0 0 45px rgba(255,255,255,.025);border-radius:28px;padding:30px;position:relative;overflow:hidden}.kicker{color:var(--cyan);letter-spacing:.22em;text-transform:uppercase;font-size:12px;font-weight:800}.title{font-size:48px;line-height:1;margin:12px 0}.tagline{color:var(--muted);font-size:18px;max-width:820px}.grid{display:grid;grid-template-columns:1.2fr .8fr;gap:18px;margin-top:18px}.cards{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-top:18px}.card{background:linear-gradient(180deg,rgba(24,5,8,.94),rgba(8,2,3,.96));border:1px solid rgba(239,18,31,.18);border-radius:22px;padding:20px;box-shadow:0 18px 44px rgba(0,0,0,.42),inset 0 0 28px rgba(255,255,255,.025)}.label{color:var(--muted);font-size:12px;text-transform:uppercase;letter-spacing:.16em}.big{font-size:42px;font-weight:900;margin-top:8px}.verdict{color:var(--gold)}.score-ring{height:190px;border-radius:22px;display:grid;place-items:center;background:radial-gradient(circle,rgba(239,18,31,.24),rgba(45,4,8,.18) 48%,rgba(255,255,255,.025));border:1px solid rgba(239,18,31,.35);box-shadow:inset 0 0 40px rgba(239,18,31,.08),0 0 38px rgba(239,18,31,.1)}.score-ring strong{font-size:58px}.score-row{display:flex;justify-content:space-between;border-bottom:1px solid rgba(255,255,255,.08);padding:12px 0;color:var(--muted)}.score-row strong{color:var(--text)}h2{margin:0 0 14px;font-size:20px}.list{margin:0;padding-left:20px;color:var(--muted);line-height:1.7}.launch{border-color:rgba(248,193,74,.35);box-shadow:0 0 44px rgba(248,193,74,.08)}.risk{border-color:rgba(244,63,94,.28)}.ok{border-color:rgba(34,197,94,.25)}.footer{margin-top:18px;color:var(--muted);font-size:13px;text-align:center}.topline{display:flex;justify-content:space-between;gap:12px;align-items:center;margin-bottom:16px;padding:12px 16px;border:1px solid rgba(239,18,31,.32);border-radius:18px;background:linear-gradient(90deg,rgba(239,18,31,.12),rgba(255,255,255,.025));box-shadow:0 0 40px rgba(239,18,31,.12)}.topline span{color:var(--cyan);font-size:12px;font-weight:800;letter-spacing:.18em;text-transform:uppercase}.topline strong{color:var(--gold);font-size:12px;letter-spacing:.14em;text-transform:uppercase}.status-strip{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:18px}.status-chip{border:1px solid rgba(255,255,255,.1);border-radius:14px;padding:12px;background:rgba(255,255,255,.035)}.status-chip span{display:block;color:var(--muted);font-size:11px;text-transform:uppercase;letter-spacing:.14em}.status-chip strong{display:block;margin-top:6px;color:var(--text);font-size:16px}.pill{display:inline-block;padding:8px 12px;border-radius:999px;background:rgba(239,18,31,.12);border:1px solid rgba(239,18,31,.38);color:#ffd7d7;margin-top:12px;box-shadow:0 0 24px rgba(239,18,31,.12)}.artifact-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.artifact{border:1px solid rgba(255,255,255,.1);border-radius:16px;padding:14px;background:rgba(255,255,255,.035)}.artifact strong{display:block;color:var(--text);font-size:14px}.artifact span{display:inline-block;margin-top:8px;font-size:11px;letter-spacing:.14em}.artifact small{display:block;margin-top:8px;color:var(--muted);font-size:11px}.artifact.ready{border-color:rgba(34,197,94,.28)}.artifact.ready span{color:var(--green)}.artifact.missing{border-color:rgba(244,63,94,.38)}.artifact.missing span{color:var(--red)}@media(max-width:840px){.grid,.cards,.artifact-grid,.status-strip{grid-template-columns:1fr}.topline{display:block}.topline strong{display:block;margin-top:8px}.title{font-size:36px}}"
